...
\begin{thebibliography}{9}
    \bibitem{peller} V.V. Peller \emph{Hankel Operators and Applications}
    \bibitem{meCesaro} Ces\`aro Summation of Fourier Series. (personal notes)
    \bibitem{meAbel} Abel Summation of Fourier Series. (personal notes)
    \bibitem{interp} Interpolation (personal notes)
    \bibitem{fefferman} Fefferman. (add more precise reference later)
\end{thebibliography}
